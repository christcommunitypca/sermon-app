    ...
    <div className={`bg-white border rounded-xl transition-all ${rowBorder}`}>
      ...
      <div className="flex items-center gap-3 px-4 py-3">
        ...
        <div className="shrink-0 flex items-center gap-1.5">
          ...
          {/* Delete button — unlinked planned weeks only */}
          {onDelete && (
            <button
              onClick={onDelete}
              disabled={!!isDeleting}
              className="flex items-center gap-1 px-2.5 py-1.5 text-xs font-medium text-red-400 border border-red-100 rounded-lg hover:bg-red-50 hover:text-red-600 transition-colors disabled:opacity-40"
