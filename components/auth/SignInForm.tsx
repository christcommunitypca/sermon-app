...
export function SignInForm({ returnTo, error }: Props) {
  ...
  const churchSlug = process.env.NEXT_PUBLIC_CHURCH_SLUG
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-2xl p-8 shadow-sm">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2.5 py-2.5 border border-slate-300 rounded-lg text-sm font-medium text-slate-700 hover:bg-slate-50 disabled:opacity-50 transition-colors"
      >
        <GoogleIcon />
